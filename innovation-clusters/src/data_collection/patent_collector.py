...
class PatentCollector:
    ...
    def _fetch_category(
        ...
        """Fetch patents for a specific CPC category"""
        ...
        while len(all_results) < limit:
            try:
                ...
                page += 1
                time.sleep(Config.USPTO_API_DELAY * 0.5)  # Shorter delay between pages
    ...
    def _filter_breakthrough(
        ...
        citations = []
        for patent in patents:
            count = patent.get('cited_by_patent_count', 0)

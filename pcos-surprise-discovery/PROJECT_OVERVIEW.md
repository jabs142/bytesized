...
PCOS affects 10% of women (1 in 10!), but doctors often focus only on the
"obvious" symptoms used for diagnosis:
...
**What about the symptoms patients actually experience but doctors rarely
discuss?**

## The Innovation: "Surprise Factor"

This project doesn't just find symptoms - it calculates which symptoms are
**surprisingly connected** to PCOS but rarely acknowledged by medical
professionals.
...
3. **Patients express surprise** (1.3x weight) - "I didn't know this was
   related!"
...
> "Which PCOS symptoms do patients experience that doctors rarely discuss, and
> what evidence exists that these connections are real?"

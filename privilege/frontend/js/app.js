...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: 'Secondary school (high school)',
        percentile: 50,
        value: 'secondary',
        source: 'UNESCO',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: 'Yes, but sometimes unreliable',
        percentile: 20,
        value: 'sometimes_unreliable',
        source: 'WHO/UNICEF',
      },
      {
        text: 'No, must collect from elsewhere',
        percentile: 9,
        value: 'must_collect',
        source: 'WHO/UNICEF',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: "Yes, but it's a financial strain",
        percentile: 40,
        value: 'financial_strain',
        source: 'WHO',
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        text: 'Yes, but limited/mobile only',
        percentile: 30,
        value: 'limited_mobile',
        source: 'ITU',
      },
  ...
  },
  {
    ...
    options: [
      {
        text: 'Yes, more than 3 months',
        percentile: 20,
        value: 'more_than_3mo',
        source: 'World Bank Global Findex',
      },
      {
        text: 'Yes, about 3 months',
        percentile: 15,
        value: 'about_3mo',
        source: 'World Bank Global Findex',
      },
...
function getFactorDescription(question, percentage, answer) {
  ...
  if (q.includes('country') || q.includes('live in')) {
    ...
    if (answer.toLowerCase().includes('university')) {
      ...
      answer.toLowerCase().includes('secondary') ||
      answer.toLowerCase().includes('high school')
    ) {
...
function getFactorVisual(question, percentile) {
  ...
  if (question.toLowerCase().includes('water')) {
    ...
    question.toLowerCase().includes('household')
  ) {
    ...
    question.toLowerCase().includes('medical') ||
    question.toLowerCase().includes('doctor') ||
    question.toLowerCase().includes('afford')
  ) {
    ...
    question.toLowerCase().includes('meals') ||
    question.toLowerCase().includes('hungry')
  ) {
    ...
    question.toLowerCase().includes('internet') ||
    ...
    question.toLowerCase().includes('live')
  ) {

...
describe('Score Validation & Regression Tests', () => {
    ...
    describe('Logical Consistency Tests', () => {
        test('better location always produces higher or equal score', () => {
            ...
            const lowerMiddle = { ...baseAnswers, location: { option: { value: 'lower-middle-income' } } };
            const upperMiddle = { ...baseAnswers, location: { option: { value: 'upper-middle-income' } } };
        ...
        test('better education always produces higher or equal score', () => {
            ...
            const primary = { ...baseAnswers, education: { option: { value: 'primary', text: 'Primary' } } };
            const secondary = { ...baseAnswers, education: { option: { value: 'secondary', text: 'Secondary' } } };
            const university = { ...baseAnswers, education: { option: { value: 'university', text: 'University' } } };
        ...
        test('better income always produces higher or equal score', () => {
            ...
            const below5k = { ...baseAnswers, income: { option: { value: 'below_5k', text: 'Below $5k' } } };
            const range5to20 = { ...baseAnswers, income: { option: { value: '5k_to_20k', text: '$5k-$20k' } } };
            const range20to50 = { ...baseAnswers, income: { option: { value: '20k_to_50k', text: '$20k-$50k' } } };
            const above50k = { ...baseAnswers, income: { option: { value: 'above_50k', text: 'Above $50k' } } };
    ...
    describe('Statistical Properties', () => {
        test('all scores fall within [0, 100] range', () => {
            const testCases = [
                { location: { option: { value: 'high-income' } }, education: { option: { value: 'university', text: 'University' } } },
                { location: { option: { value: 'low-income' } }, education: { option: { value: 'none', text: 'None' } } },
                { location: { option: { value: 'upper-middle-income' } }, income: { option: { value: '5k_to_20k', text: '$5k-$20k' } } },
                { water: { option: { value: 'must_collect', text: 'Must collect' } }, hunger: { option: { value: 'frequently', text: 'Frequently' } } }
            ];

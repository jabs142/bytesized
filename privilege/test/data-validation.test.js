...
describe('Data Validation Tests', () => {
    ...
    describe('Countries Data Validation', () => {
        ...
        test('all income groups are valid', () => {
            const validGroups = ['high-income', 'upper-middle-income', 'lower-middle-income', 'low-income'];
    ...
    describe('Conditional Probabilities Data Validation', () => {
        ...
        test('all percentile values are in valid range [0-100]', () => {
            function checkPercentiles(obj, path = '') {
                for (const [key, value] of Object.entries(obj)) {
                    ...
                    if (typeof value === 'number' && (key.includes('percentile') || path.includes('percentile'))) {
        ...
        test('probability distributions sum to approximately 1.0', () => {
            ...
            if (conditionalProbabilities.education_given_location) {
                for (const [incomeGroup, eduDist] of Object.entries(conditionalProbabilities.education_given_location)) {
                    if (incomeGroup.startsWith('_')) continue;
            ...
            if (conditionalProbabilities.water_given_location) {
                for (const [incomeGroup, waterDist] of Object.entries(conditionalProbabilities.water_given_location)) {
                    if (incomeGroup.startsWith('_')) continue;
    ...
    describe('Cross-Reference Validation', () => {
        ...
        test('countries income groups match calculator location values', () => {
            const calcLocationValues = ['high-income', 'upper-middle-income', 'lower-middle-income', 'low-income'];
